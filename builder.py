...
print(Fore.GREEN + '+' + Fore.BLUE +  "       Developer: @rxc_official         " + Fore.GREEN + '+')
print(Fore.GREEN + '+' + Fore.BLUE +  "        Channel: @rxc_official         " + Fore.GREEN + '+')
print(Fore.GREEN + '#########################################')
...
def slivmens(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @rxc_official. Канал: @rxc_official') 
